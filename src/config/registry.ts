export const registryConfig = {
   ...
   */
  namespace: process.env.REGISTRY_NAMESPACE || "@nsrawat",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://nsrawat.in/r/{name}.json" resolves to "https://nsrawat.in/r/wheel-picker.json"
   ...
   */
  namespaceUrl:
    process.env.REGISTRY_NAMESPACE_URL || "https://nsrawat.in/r/{name}.json",
};
